...
WORDING : Dict[str, Any] =\
{
	...
	'help':
	{
		...
		'face_swapper_vr_mode': 'enable VR mode to process split frames for stereoscopic content',
		'face_swapper_vr_mode_split': 'choose how to split the frame for VR processing (horizontal or vertical)',
	...
	'uis':
	{
		...
		'face_swapper_vr_mode_checkbox': 'vr mode',
		'face_swapper_vr_mode_split_dropdown': 'vr mode split',
